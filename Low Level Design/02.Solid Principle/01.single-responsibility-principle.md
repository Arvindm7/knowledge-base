...
Now, implementing all the above functionalities in a single `Compiler` class would **violate the Single Responsibility Principle (SRP)**.
...
| **Example** | Split `Compiler` into `SyntaxChecker`, `TestRunner`, `DatabaseManager`, etc. |
